...
?>
<h3 class="taler-settings-subheading"><?php echo esc_html__('Base URL', 'mirrorps-payments-for-gnu-taler'); ?></h3>
<form id="taler-baseurl-form" method="post" action="<?php echo esc_url(admin_url('options.php')); ?>">
    ...
    <table class="form-table" role="presentation">
        <tr>
            <th scope="row"><label for="taler-base-url"><?php echo esc_html__('Taler Base URL *', 'mirrorps-payments-for-gnu-taler'); ?></label></th>
            <td>
                <input
                    type="text"
                    id="taler-base-url"
