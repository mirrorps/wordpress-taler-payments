...
?>
<h3 class="taler-settings-subheading"><?php echo esc_html__('Access Token', 'mirrorps-payments-for-gnu-taler'); ?></h3>
<form id="taler-token-form" method="post" action="<?php echo esc_url(admin_url('options.php')); ?>">
    ...
    <table class="form-table" role="presentation">
        <tr>
            <th scope="row"><label for="taler-token"><?php echo esc_html__('Access Token *', 'mirrorps-payments-for-gnu-taler'); ?></label></th>
            <td>
                <input
                    type="password"
                    id="taler-token"
